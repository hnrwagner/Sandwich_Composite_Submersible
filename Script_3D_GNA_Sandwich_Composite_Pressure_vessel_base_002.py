...
Create_Riks_Analysis_Step(myString)
...
Create_Pressure_Load(myString,"Submersible_Shell-1","External_Pressure_sphere","Step-1","External_Surface_sphere",20)
Create_Pressure_Load(myString,"Submersible_Shell-1","External_Pressure_cylinder","Step-1","External_Surface_cylinder",20)
